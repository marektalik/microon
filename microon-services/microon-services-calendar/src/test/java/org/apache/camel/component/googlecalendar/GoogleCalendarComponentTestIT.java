...
public class GoogleCalendarComponentTestIT extends CamelTestSupport {
    ...
    protected void doPreSetup() throws Exception {
        super.doPostSetup();
//        sendBody("direct:test", new ListAndRemoveEvents());
//        sendBody("direct:test", new CreateEvent("Name", new Date(), Collections.singletonList(firstParticipantEmail)));
//        sendBody("direct:test", new CreateEvent("Name", new Date(), Collections.singletonList(secondParticipantEmail)));
    }
